...
public class StowSensor implements ScreenStateNotifier, SensorEventListener {
    ...
    public void screenTurnedOff() {
        if ((mLineageActionsSettings.isPocketGestureEnabled()
                || mLineageActionsSettings.isIrWakeupEnabled())
                && !mEnabled) {
            Log.d(TAG, "Enabling");
    ...
    private boolean shouldPulse(long timestamp) {
        ...
        boolean irWakeupEnabled = mLineageActionsSettings.isIrWakeupEnabled();
        boolean pocketGestureEnabled = mLineageActionsSettings.isPocketGestureEnabled();
